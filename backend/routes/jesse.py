...
def sync_strategy_parameters(req: StrategySyncRequest = StrategySyncRequest()) -> Dict[str, Any]:
    ...
    Re-runs resolve_promotion immediately. REJECT restores .env / os.environ
    and returns HTTP 409. Rejected B200 artifacts are never promoted.
    """
    result = jesse_bridge.sync_strategy_to_risk_config(
