...
| `12_jev_outcome_filler_workflow.json` | Hourly at :20 | Supabase `jev_signals` + Binance Futures klines | Scores Jev Ensemble v2 signals vs the next full candle (`WIN`/`LOSS`/`SCRATCH`, `SKIP_*`). Stats: `supabase/jev_signal_scorecard.sql` |
